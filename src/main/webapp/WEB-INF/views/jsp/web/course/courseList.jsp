...
<div class="wrap">
	...
	<div class="crumbs">
		<i class="iconfont">&#xe628;</i>我的菜单<span>&gt;</span>课程管理<span>&gt;</span>课程列表
	</div>
			...
			<td class="vertical-main">
				<form name="searchForm" id="searchForm" method="post">
					...
					<h2>
						...
						<a href="javascript:void(0);" class="button button-success" id="addBtn">新增课程</a>
					</h2>
				</form>
				<!-- 用户分页信息 -->
	...
	<script src="resources/js/src/web/course/courseList.js" type="text/javascript"></script>
</div>
